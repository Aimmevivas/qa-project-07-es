...
class UrbanRoutesPage:
    ...
    comfort_button = (By.XPATH, "//div/div[3]/div[3]/div[2]/div[1]/div[5]/div[2]']")
    ...
    payment_method_open = (By.XPATH, "//div[@class='pp-button filled']//div[@class='pp-text' and text()='Método de pago']")
    payment_input_section = (By.XPATH, "//div[@class='modal']//div[@class='section active']//button[text()='Cancelar']")
    add_card_open = (By.XPATH, "//div[contains(@class, 'pp-row') and contains(@class, 'disabled') and .//div[@class='pp-title' and text()='Agregar tarjeta']])
